namespace InheritancePart1Exercises_Models.Exercise_2
{
    ...
    {
        // Constructor to initialize the human with a name
        ...
        // Override method for eating (human-specific behavior)
        public override string Eat()
        {
            return "Yummy!";
        }

        // Override method for caressing (human-specific behavior)
        public override string Caress()
        {
            return "Get your hands off me!";
        }

        // Override method for talking (human-specific behavior)
