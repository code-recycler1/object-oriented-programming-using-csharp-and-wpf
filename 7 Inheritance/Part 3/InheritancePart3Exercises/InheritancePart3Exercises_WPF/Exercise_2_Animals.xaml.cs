using InheritancePart3Exercises_Models.Exercise_2;
...
namespace InheritancePart3Exercises_WPF
{
    public partial class Exercise_2_Animals : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // lstAnimals.DisplayMemberPath = "Data"; // Commented out to test ToString()
        }
        ...
        private void btnCreate_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtName.Text))
            {
                ...
                {
                    MessageBox.Show($"This animal already exists: {animal}", "Error");
                }
            }
            else
            {
